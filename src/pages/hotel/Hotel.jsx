      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          ...
          <span className="hotelPriceHighlight">
            Book a stay over 10000Rs at this property and get a free airport
            taxi.
          </span>
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsText">
              ...
              <p className="hotelDesc">
                The Taj Mahal Palace, Mumbai is conveniently located within
                touching distance to prominent tourist attractions in and around
                Mumbai. Our hotel in Mumbai is also the perfect destination for
                a blissful getaway from Ahmedabad. Enjoy our warm hospitality
                and service that make you feel at home. Explore the all meals
                inclusive 4D Travel offer to plan your next stay.
              </p>
            </div>
            <div className="hotelDetailsPrice">
              ...
              <span>
                ...
                excellent location score for 9.6!
              </span>
              <h2>
